...
namespace SysSoniaInventory.Controllers
{
    ...
    public class MarcaController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchName, int page = 1)
        {
            ...
            var query = _context.modelMarca.AsQueryable();
            ...
            int totalMarcas = await query.CountAsync();
            ...
            ViewBag.TotalPages = (int)Math.Ceiling((double)totalMarcas / pageSize);
        ...
        public IActionResult GeneratePdfMarca()
        {
            ...
            using (var stream = new MemoryStream())
            {
                ...
                // Celda del título
                Cell titleCell = new Cell().Add(new Paragraph("Todas las Marcas")
                    .SetFontSize(20)
                ...
                return File(stream.ToArray(), "application/pdf", $"Marcas_{fechaDescarga}.pdf");
